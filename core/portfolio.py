...
- [BUG FIX] Streamlit Cloud 환경에서 sys.frozen 체크가 무의미하고
  __file__ 기반 경로가 /mount/src/… 로 잡혀 data/ 폴더 생성 실패
...
class Portfolio:
    ...
    def _get_default_structure(self) -> dict:
        return {
            "holdings": {
                "AAPL": 0.0, "MSFT": 0.0, "NVDA": 0.0, "GOOGL": 0.0, "AMZN": 0.0,
                "META": 0.0, "TSLA": 0.0, "ORCL": 0.0, "PLTR": 0.0, "AVGO": 0.0,
                "TSM": 0.0, "AMD": 0.0, "MU": 0.0, "MRVL": 0.0, "ASML": 0.0,
                "AMAT": 0.0, "KLAC": 0.0, "LRCX": 0.0, "CDNS": 0.0, "ARM": 0.0,
                "NOW": 0.0, "CRM": 0.0, "CRWD": 0.0, "PANW": 0.0, "AXON": 0.0,
                "CEG": 0.0, "VST": 0.0, "GEV": 0.0, "LLY": 0.0, "ISRG": 0.0,
            },
            "benchmarks": ["QQQM", "XLK"],
